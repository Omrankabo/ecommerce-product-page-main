...
const Header = () => {
  ...
  return (
    <header className='container flex items-center justify-between p-4  lg:p-6 px-8 mx-auto bg-white lg:border-b lg:max-w-screen-md xl:max-w-[1100px]'>
      ...
      <div className={ `${open? 'left-0': '-left-full'} fixed top-0 z-40 w-1/2 h-full p-6 lg:h-16 lg:w-[500px]  lg:relative lg:bg-transparent lg:shadow-none lg:-left-[5%] xl:-left-[17%] lg:-top-1 bg-white rounded-md shadow-xl transition-all duration-300`}>
        ...
        <ul className='flex flex-col justify-around h-56 text-xl font-bold lg:font-normal lg:text-base xl:text-lg text-varkBlue lg:text-darkblue lg:flex-row '>
            ...
            <li className='lg:h-[4.3rem] lg:hover:border-b-8 border-primary transition-all duration-150 cursor-pointer'>About</li>
            <li className='lg:h-[4.3rem] lg:hover:border-b-8 border-primary transition-all duration-150 cursor-pointer'>Contact</li>
        </ul>
      </div>

      <div className='flex items-center justify-between w-24 lg:w-32 '>
        <div onClick={()=>setIsOpen(!isOpen)} className='relative cursor-pointer'>
          <BsCart3 className='text-2xl text-darkblue'/>
